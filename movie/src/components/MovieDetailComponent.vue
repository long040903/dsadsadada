<template>
  ...
  <div class="p-4">
    <div class="mx-40 p-4 rounded-lg">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-5">
          <div class="relative">
            <img
              alt="Movie poster showing a group of people with various expressions"
              class="rounded-lg w-full"
              src="https://cinestar.com.vn/_next/image/?url=https%3A%2F%2Fapi-website.cinestar.com.vn%2Fmedia%2Fwysiwyg%2FPosters%2F02_2025%2Fnha-gia-tien-sneak.jpg&w=640&q=75"
            />
            <div
        ...
        <div class="col-span-7 mt-4 md:mt-0 space-y-8">
          <h1 class="text-3xl font-bold uppercase">nhà gia tiên (T18)</h1>
          ...
          <div class="mt-4">
            ...
            <p class="mt-2">Đạo diễn: Huỳnh Lập</p>
            <p>
              Diễn viên: Huỳnh Lập, Phương Mỹ Chi, NSƯT Hạnh Thúy, NSƯT Huỳnh
              Đông, Puka, Đào Anh Tuấn, Trung Dân, Kiều Linh, Lê Nam, Chí Tâm,
              Thanh Thức, Trác Thúy Miêu, Mai Thế Hiệp, NS Mạnh Dung, NSƯT Thanh
              Dậu, NS Thanh Hiền, Nguyễn Anh Tú,...
            </p>
            <p>Khởi chiếu: Thứ Sáu, 21/02/2025</p>
          </div>
          <div class="mt-4">
            <h2 class="text-xl font-bold">NỘI DUNG PHIM</h2>
            <p class="mt-2">
              Nhà Gia Tiến xoay quanh câu chuyện đa góc nhìn về các thế hệ khác
              nhau trong một gia đình, có hai nhân vật chính là Gia Minh (Huỳnh
              Lập) và Mỹ Tiên (Phương Mỹ Chi). Trở về căn nhà gia tiên để quay
              các video “triệu view” trên mạng xã hội, Mỹ Tiên - một nhà sáng
              tạo nội dung thuộc thế hệ Z vốn không tin vào chuyện tâm linh,
              hoàn toàn mất kết nối với gia đình, bất ngờ gặp lại thấy Gia Minh
              - người anh trai đã mất từ lâu. Để hồn ma của Gia Minh có thể siêu
              thoát và không tiếp tục làm phiền...
            </p>
            <a
    ...
    >
      <div class="text-center">
        ...
        <div class="flex justify-center space-x-4 mb-8">
          <div class="bg-yellow-400 text-black px-4 py-2 rounded">
            02/03<br />Chủ Nhật
          </div>
          <div class="border border-yellow-400 px-4 py-2 rounded">
            03/03<br />Thứ Hai
          </div>
          <div class="border border-yellow-400 px-4 py-2 rounded">
            04/03<br />Thứ Ba
        ...
        <button class="border border-yellow-400 px-4 py-2 rounded mb-8">
          HỒ CHÍ MINH
        </button>
      </div>
      <div class="w-full max-w-4xl">
        ...
        <div class="bg-purple-700 p-4 mb-4 rounded">
          ...
          <div class="grid grid-cols-6 gap-2">
            <div class="border border-white px-2 py-1 rounded toggle-button">
              09:15
            </div>
            <div class="border border-white px-2 py-1 rounded toggle-button">
              09:45
  ...
  >
    ...
    <div class="container mx-auto text-center">
      ...
      <div class="legend">
        <div class="normal"><span></span> Ghế Thường</div>
        <div class="double"><span></span> Ghế Đôi (2 Người)</div>
        <div class="selected"><span></span> Ghế chọn</div>
        <div class="booked"><span></span> Ghế đã đặt</div>
      </div>
    </div>
    <div class="p-4">
      <div class="text-center text-2xl font-bold mb-8">CHỌN BẮP NƯỚC</div>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="text-center">
          <img
            ...
            width="100"
          />
          <div class="font-bold">COMBO GẤU</div>
          <div>1 Cake 32oz + 1 Bắp 2 Ngăn 64oz Phô Mai + Caramel</div>
          <div class="font-bold">119,000 VND</div>
          <div class="flex justify-center items-center mt-2">
            <button class="bg-gray-700 text-white px-2 py-1">-</button>
        ...
        <div class="text-center">
          <img
            alt="Combo Có Gấu image"
            class="mx-auto mb-4"
            height="100"
            src="https://storage.googleapis.com/a1aa/image/B0UK9xsMRdm92h9SRcT-gaPnf6hhGMBZ8ioxT_jZGSU.jpg"
            width="100"
          />
          <div class="font-bold">COMBO CÓ GẤU</div>
          <div>2 Cake 32oz + 1 Bắp 2 Ngăn 64oz Phô Mai + Caramel</div>
          <div class="font-bold">129,000 VND</div>
          <div class="flex justify-center items-center mt-2">
            <button class="bg-gray-700 text-white px-2 py-1">-</button>
            <input class="w-12 text-center mx-2" type="text" value="0" />
            <button class="bg-gray-700 text-white px-2 py-1">+</button>
        ...
        <div class="text-center">
          <img
            alt="Combo Nhà Gấu image"
            class="mx-auto mb-4"
            height="100"
            src="https://storage.googleapis.com/a1aa/image/hSGeusZBWcah6yzBQ_wLoVzhumO4JuaEnuVy7vIHgMs.jpg"
            width="100"
          />
          <div class="font-bold">COMBO NHÀ GẤU</div>
          <div>4 Cake 32oz + 1 Bắp 2 Ngăn 64oz Phô Mai + Caramel</div>
          <div class="font-bold">259,000 VND</div>
          <div class="flex justify-center items-center mt-2">
            <button class="bg-gray-700 text-white px-2 py-1">-</button>
            <input class="w-12 text-center mx-2" type="text" value="0" />
            <button class="bg-gray-700 text-white px-2 py-1">+</button>
        ...
        <div class="text-center">
          <img
            ...
            width="100"
          />
          <div class="font-bold">COKE 32OZ</div>
          <div>37,000 VND</div>
          <div class="flex justify-center items-center mt-2">
            <button class="bg-gray-700 text-white px-2 py-1">-</button>
            <input class="w-12 text-center mx-2" type="text" value="0" />
      ...
      <div class="mt-8 text-center">
        <div class="font-bold">NHÀ GIÁ TIẾN (T18)</div>
        <div>Cinestar Quốc Thanh (TPHCM)</div>
      </div>
      <div
        id="booking-bar"
      ...
      >
        <div class="text-center">
          ...
          <div class="bg-yellow-500 text-black font-bold px-2 py-1">05:00</div>
        </div>
        <div class="text-center">
          <div>Tạm tính</div>
          <div class="font-bold">0 VND</div>
        </div>
...
.bg-gradient-1 {
  background: linear-gradient(
    106deg,
    rgba(102, 51, 153, 0.8),
    rgba(51, 102, 204, 0.8) 102.69%
  );
}

/* Background app */
.main-dc-1::before {
  background: url(https://cinestar.com.vn/assets/images/mobile-blur-6.webp);
  filter: blur(10rem);
  left: 0;
  top: 100rem;
...
.main-dc-2::before {
  background: url(https://cinestar.com.vn/assets/images/mobile-blur-4.webp);
  filter: blur(10rem);
  left: 0;
  top: min(100rem, 50%);
}
...
.main-dc-2::after {
  background: url(https://cinestar.com.vn/assets/images/mobile-blur-5.webp);
  filter: blur(7rem);
  right: 0;
  top: min(100rem, 50%);
  transform: translateY(-20%);
