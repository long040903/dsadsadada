                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody>
                            <tr v-for="(cinemas, index) in cinemas" :key="cinemas.cinema_id">
                                ...
                                <td class="py-2 px-4 border-b">{{ cinemas.cinema_id }}</td> <!-- Mã phim -->
                                <td class="py-2 px-4 border-b">{{ cinemas.name }}</td> <!-- Tên phim -->
                                <td class="py-2 px-4 border-b">{{ cinemas.address }}</td>
                                <td class="py-2 px-4 border-b">{{ cinemas.phone }}</td>
                                <td class="py-2 px-4 border-b">{{ cinemas.capacity }}</td>
